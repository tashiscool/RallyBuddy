 ...
 *       &lt;sequence>
 *         &lt;element name="UserIterationCapacity" type="{http://rallydev.com/webservice/v1_34/domain}UserIterationCapacity" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class IterationUserIterationCapacitiesType {
    ...
    protected List<UserIterationCapacity> userIterationCapacity;
     ...
     * {@link UserIterationCapacity }
     * 
     * 
     */
    public List<UserIterationCapacity> getUserIterationCapacity() {
        if (userIterationCapacity == null) {
            userIterationCapacity = new ArrayList<UserIterationCapacity>();
        }
