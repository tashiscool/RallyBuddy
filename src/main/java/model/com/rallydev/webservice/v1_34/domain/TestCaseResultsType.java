 ...
 *       &lt;sequence>
 *         &lt;element name="TestCaseResult" type="{http://rallydev.com/webservice/v1_34/domain}TestCaseResult" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class TestCaseResultsType {
    ...
    protected List<TestCaseResult> testCaseResult;
    ...
    public List<TestCaseResult> getTestCaseResult() {
        if (testCaseResult == null) {
            testCaseResult = new ArrayList<TestCaseResult>();
        }
