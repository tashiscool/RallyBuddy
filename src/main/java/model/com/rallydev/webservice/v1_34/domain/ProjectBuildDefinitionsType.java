 ...
 *       &lt;sequence>
 *         &lt;element name="BuildDefinition" type="{http://rallydev.com/webservice/v1_34/domain}BuildDefinition" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ProjectBuildDefinitionsType {
    ...
    protected List<BuildDefinition> buildDefinition;
    ...
    public List<BuildDefinition> getBuildDefinition() {
        if (buildDefinition == null) {
            buildDefinition = new ArrayList<BuildDefinition>();
        }
